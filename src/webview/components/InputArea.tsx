...
const MODELS = [
  { value: 'claude-opus-4-6', label: 'Opus', desc: 'Most capable, complex tasks', color: '#a78bfa', icon: 'â˜? },
  { value: 'claude-sonnet-4-5-20250929', label: 'Sonnet', desc: 'Fast and balanced', color: '#60a5fa', icon: 'â—? },
  { value: 'claude-haiku-4-5-20251001', label: 'Haiku', desc: 'Lightweight and quick', color: '#4ade80', icon: 'â—? },
  { value: 'default', label: 'Default', desc: 'User configured model', color: '#9ca3af', icon: 'â—? },
]
