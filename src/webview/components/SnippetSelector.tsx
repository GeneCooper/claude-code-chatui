...
export const SnippetDropdown = memo(function SnippetDropdown({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      {allSnippets.map((snippet) => {
        ...
        return (
          <div
            ...
            onMouseLeave={(e) => { e.currentTarget.style.background = isSelected ? 'rgba(167, 139, 250, 0.08)' : 'transparent' }}
      ...
      {/* Divider */}
      <div style={{ height: '1px', background: 'var(--vscode-panel-border)', margin: '6px 12px' }} />
